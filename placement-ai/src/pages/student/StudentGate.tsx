  ...
  useEffect(() => {
    const checkStudentStatus = async () => {
      try {
        ...
        } else if (!data.hasUploadedResume) {
          // Logged in but no resume - redirect to onboarding
          setTimeout(() => {
            navigate('/onboarding')
          }, 1000)
        } else {
          // Logged in and has resume - redirect to dashboard
          setTimeout(() => {
            navigate('/dashboard')
          }, 1000)
        }
      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl p-8 text-center">
          ...
          >
            ...
            <p className="text-gray-600 mt-2">Placement Management System</p>
          </motion.div>
